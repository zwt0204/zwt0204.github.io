---
layout: post
title: "arXiv 论文精读：Re$^3$Cap: Retrieval-Guided Refinement for Image Captioning Enhancement via Reinforcement Learning (2026-08-24)"
subtitle: "单篇论文深度拆解"
...
- arXiv：[2608.21305](http://arxiv.org/abs/2608.21305v1)
- PDF：[https://arxiv.org/pdf/2608.21305v1](https://arxiv.org/pdf/2608.21305v1)
- 作者：Haonan Jia、Shichao Dong、Zenghui Sun、Jiawen Zheng、Ziqi Miao、Gege Shi、等
- 发布时间：2026-08-21，更新时间：2026-08-21
- 类别：cs.CV、cs.AI
- 主题标签：LLM、多模态、RAG/Memory、Reasoning、Safety/Eval

### 摘要速读

Reinforcement Learning (RL) has demonstrated significant gains in image captioning, yet it is still limited in encouraging Large Vision-Language Models (LVLMs) to explore novel reasoning strategies. This limitation leads to a performance gap between RL and Supervised Fine-Tuning (SFT).
...
![Re$^3$Cap: Retrieval-Guided Refinement for Image Captioning Enhancement via Reinforcement Learning 方法架构图](/img/daily-reports/2026-08-24-paper-re-3-cap-retrieval-guided-refinement-for-image-captioning-enhancement-via-reinforcement-le-architecture.svg)
