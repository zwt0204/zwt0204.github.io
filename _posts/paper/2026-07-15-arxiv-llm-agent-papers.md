---
layout: post
title: "arXiv 论文精读：Do We Really Need Multimodal Emotion Language Models Larger Than 1B Parameters? (2026-07-15)"
subtitle: "单篇论文深度拆解"
...
- arXiv：[2607.12787](http://arxiv.org/abs/2607.12787v1)
- PDF：[https://arxiv.org/pdf/2607.12787v1](https://arxiv.org/pdf/2607.12787v1)
...
Recent advances in multimodal large language models (MLLMs) have significantly improved the performance of multimodal emotion recognition (MER) and enabled interpretable description generation by jointly modeling video, audio, and language, etc. However, these performance improvements are often accompanied by an increase in model parameter size (e.g, at least 7B), which simultaneously incurs high computational costs and reduces inference efficiency, thereby hindering real-time deployment on resource-constrained...
...
![Do We Really Need Multimodal Emotion Language Models Larger Than 1B Parameters? 方法架构图](/img/daily-reports/2026-07-15-paper-do-we-really-need-multimodal-emotion-language-models-larger-than-1b-parameters-architecture.svg)
