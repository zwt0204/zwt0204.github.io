---
layout: post
title: "arXiv 论文精读：Decoupling Semantics from Distortions: Multi-Scale Two-Stream Vision-Language Alignment for AI-Generated Image Quality Assessment (2026-06-16)"
subtitle: "单篇论文深度拆解"
...
这篇论文关注 AI 生成图像质量评估里一个容易被混淆的问题：语义是否正确，和图像是否有失真，并不是同一个信号。一个图可以语义很对但局部细节崩坏，也可以画质很干净但语义不符合指令。
...
![Decoupling Semantics from Distortions: Multi-Scale Two-Stream Vision-Language Alignment for AI-Generated Image Quality Assessment 方法架构图](/img/daily-reports/2026-06-16-paper-decoupling-semantics-from-distortions-multi-scale-two-stream-vision-language-alignment-for-architecture.svg)
...
- **语义/失真解耦**：AI 生成图像质量评估不能把“语义好看”和“画质无瑕疵”混在一起；两流设计的价值就在拆开这两个信号。
