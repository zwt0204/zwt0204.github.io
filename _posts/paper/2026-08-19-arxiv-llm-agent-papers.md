---
layout: post
title: "arXiv 论文精读：Memory Tree Guided Key Frame Querying for Efficient 3D Question Answering (2026-08-19)"
subtitle: "单篇论文深度拆解"
...
- arXiv：[2608.18009](http://arxiv.org/abs/2608.18009v1)
- PDF：[https://arxiv.org/pdf/2608.18009v1](https://arxiv.org/pdf/2608.18009v1)
- 作者：Hsiang-Wei Huang、Fu-Chen Chen、Li-Wu Tsao、Cheng-Han Lee、Che-Chun Su、Lu Xia、等
...
![Memory Tree Guided Key Frame Querying for Efficient 3D Question Answering 方法架构图](/img/daily-reports/2026-08-19-paper-memory-tree-guided-key-frame-querying-for-efficient-3d-question-answering-architecture.svg)
