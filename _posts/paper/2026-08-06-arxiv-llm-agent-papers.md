---
layout: post
title: "arXiv 论文精读：OmniEdit-Bench: A Comprehensive Benchmark for Instruction-based Video Editing (2026-08-06)"
subtitle: "单篇论文深度拆解"
...
- arXiv：[2608.05049](http://arxiv.org/abs/2608.05049v1)
- PDF：[https://arxiv.org/pdf/2608.05049v1](https://arxiv.org/pdf/2608.05049v1)
- 作者：Chenxuan Miao、Yutong Feng、Yi Lu、Yunfeng Yan、Donglian Qi、Shiwei Zhang、等
- 发布时间：2026-08-05，更新时间：2026-08-05
- 类别：cs.CV
- 主题标签：LLM、多模态、RAG/Memory、Reasoning、Safety/Eval

### 摘要速读

Instruction-based video editing (IVE) is an emerging field with broad applications, yet evaluating editing models remains challenging. Existing benchmarks suffer from two major limitations: limited task coverage inherited from image editing, which overlooks video-specific dimensions, and inadequate metrics that fail to measure instruction fidelity, allowing incorrect edits to receive high scores due to strong visual priors from the original video.
...
![OmniEdit-Bench: A Comprehensive Benchmark for Instruction-based Video Editing 方法架构图](/img/daily-reports/2026-08-06-paper-omniedit-bench-a-comprehensive-benchmark-for-instruction-based-video-editing-architecture.svg)
