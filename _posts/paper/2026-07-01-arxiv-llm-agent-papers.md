---
layout: post
title: "arXiv 论文精读：UniCoder: Unified Visual-to-Code Generation via Symbolic Rewards and Reference-Guided Code Optimization (2026-07-01)"
subtitle: "单篇论文深度拆解"
...
## [UniCoder: Unified Visual-to-Code Generation via Symbolic Rewards and Reference-Guided Code Optimization](http://arxiv.org/abs/2606.31732v1)

- arXiv：[2606.31732](http://arxiv.org/abs/2606.31732v1)
- PDF：[https://arxiv.org/pdf/2606.31732v1](https://arxiv.org/pdf/2606.31732v1)
- 作者：Yaozhi Zheng、Yilei Jiang、Manyuan Zhang、Yuxuan Wan、Kaituo Feng、Tianshuo Peng、等
...
![UniCoder: Unified Visual-to-Code Generation via Symbolic Rewards and Reference-Guided Code Optimization 方法架构图](/img/daily-reports/2026-07-01-paper-unicoder-unified-visual-to-code-generation-via-symbolic-rewards-and-reference-guided-code-architecture.svg)
