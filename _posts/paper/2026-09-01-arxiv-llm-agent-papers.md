---
layout: post
title: "arXiv 论文精读：LOCI: A Locator-Critic with Refinement Loop (2026-09-01)"
subtitle: "单篇论文深度拆解"
...
- arXiv：[2608.30959](http://arxiv.org/abs/2608.30959v1)
- PDF：[https://arxiv.org/pdf/2608.30959v1](https://arxiv.org/pdf/2608.30959v1)
- 作者：Walid Bousselham、Mathilde Caron、Arsha Nagrani、Cordelia Schmid
- 发布时间：2026-08-31，更新时间：2026-08-31
- 类别：cs.CV、cs.AI
- 主题标签：LLM、多模态、Agent、Reasoning、Safety/Eval

### 摘要速读

Vision-Language Models (VLMs) still struggle on tasks requiring complex visual understanding. We argue that the core issue is not high-level reasoning, but instead failing to locate critical details in the image.
...
![LOCI: A Locator-Critic with Refinement Loop 方法架构图](/img/daily-reports/2026-09-01-paper-loci-a-locator-critic-with-refinement-loop-architecture.svg)
