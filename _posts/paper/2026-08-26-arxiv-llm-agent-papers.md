---
layout: post
title: "arXiv 论文精读：PhysMLLMs: Spatial Priors for Unified Referring Segmentation and Grounded Reasoning of Images and Videos (2026-08-26)"
subtitle: "单篇论文深度拆解"
...
## [PhysMLLMs: Spatial Priors for Unified Referring Segmentation and Grounded Reasoning of Images and Videos](http://arxiv.org/abs/2608.24574v1)

- arXiv：[2608.24574](http://arxiv.org/abs/2608.24574v1)
- PDF：[https://arxiv.org/pdf/2608.24574v1](https://arxiv.org/pdf/2608.24574v1)
- 作者：Siyao Yan、Bo Han、Jisheng Dang、Bimei Wang、Shude Wang、Hong Peng、等
- 发布时间：2026-08-25，更新时间：2026-08-25
- 类别：cs.AI
- 主题标签：LLM、多模态、RAG/Memory、Reasoning、Safety/Eval

### 摘要速读

Video multimodal large language models support language guided video segmentation, but they often show spatio temporal inconsistencies, e.g., jitter, drift, and identity switches. These failures are more common when targets are partly hidden or when similar objects appear nearby.One likely reason is that current training lacks explicit spatial priors, which makes it difficult to maintain stable spatial identity and shape over time.
...
![PhysMLLMs: Spatial Priors for Unified Referring Segmentation and Grounded Reasoning of Images and Videos 方法架构图](/img/daily-reports/2026-08-26-paper-physmllms-spatial-priors-for-unified-referring-segmentation-and-grounded-reasoning-of-imag-architecture.svg)
