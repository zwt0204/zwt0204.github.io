---
layout: post
title: "arXiv 论文精读：Cortex: A Bidirectionally Aligned Embodied Agent Framework for Long-horizon Manipulation (2026-07-07)"
subtitle: "单篇论文深度拆解"
...
- arXiv：[2607.05377](http://arxiv.org/abs/2607.05377v1)
- PDF：[https://arxiv.org/pdf/2607.05377v1](https://arxiv.org/pdf/2607.05377v1)
- 作者：Jiaqi Peng、Xiqian Yu、Delin Feng、Yuqiang Yang、Wenzhe Cai、Jing Xiong、等
- 发布时间：2026-07-06，更新时间：2026-07-06
- 类别：cs.RO、cs.AI、cs.CV
- 主题标签：多模态、Agent、Skill/Tool、Reasoning、Safety/Eval
...
![Cortex: A Bidirectionally Aligned Embodied Agent Framework for Long-horizon Manipulation 方法架构图](/img/daily-reports/2026-07-07-paper-cortex-a-bidirectionally-aligned-embodied-agent-framework-for-long-horizon-manipulation-architecture.svg)
