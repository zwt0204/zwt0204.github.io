---
layout: post
title: "GitHub Trending 精读：Tencent/WeKnora (2026-09-18)"
subtitle: "单个开源项目深度拆解"
date: 2026-09-18
author: "zwt"
...
- 语言：Go
- Stars：26,579，Forks：3,582，今日新增：1,125
- Topics：agent、agentic、ai、chatbot、dsh-plugin、embeddings
- 官网/演示：[https://weknora.weixin.qq.com](https://weknora.weixin.qq.com)
- 项目类型：AI/Agent 工程项目
...
![Tencent/WeKnora 架构拆解图](/img/daily-reports/2026-09-18-github-tencent-weknora-architecture.svg)
...
![Tencent/WeKnora 代码调用链图](/img/daily-reports/2026-09-18-github-tencent-weknora-call-chain.svg)
...
- README 结构：💡 WeKnora — Turn Documents into Living Knowledge with RAG, Agents and Auto-Wiki / 📌 Overview / ✨ Latest Updates / 📱 Interface Showcase / 🏗️ Architecture / 🧩 Feature Overview
- 开篇信息：https://github.com/user-attachments/assets/19b28ce2-a62f-4f54-b289-c983576259bc It is organized around three core capabilities: **RAG-based Quick Q&A** for everyday lookups, a **ReAct Agent** that autonomously orchestrates retrieval, MCP tools, a **tenant skill catalog**, session-persistent **Docker / E2B / Cube sandboxes** and web search to handle complex multi-step tasks, and a brand-new **Wiki Mode** in which agents distill raw documents into a self-maintaining, interlinked markdown knowledge base with an intera
...
- `cli/README.md`
- `cli/go.mod`
- `cmd/milvus-migrate/README.md`
- `internal/application/access/README.md`
- `internal/datasource/README.md`
- `internal/infrastructure/web_fetch/testdata/extraction/README.md`
- `internal/modelcontext/README.md`
- `internal/textconv/data/README.md`
- `packages/dsh-weknora/README.md`
...
| 文件/目录 | 阅读重点 |
| --- | --- |
| `cli/Makefile` | 用于定位项目的核心边界和上下游依赖。 |
| `cli/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `cli/go.mod` | 用于定位项目的核心边界和上下游依赖。 |
| `cmd/milvus-migrate/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `internal/application/access/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `internal/datasource/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `internal/infrastructure/web_fetch/testdata/extraction/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `internal/modelcontext/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `internal/textconv/data/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/dsh-weknora/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/dsh-weknora/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `docs/api/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
