---
layout: post
title: "GitHub Trending 精读：earendil-works/pi (2026-09-16)"
subtitle: "单个开源项目深度拆解"
date: 2026-09-16
author: "zwt"
...
- 语言：TypeScript
- Stars：105,965，Forks：13,322，今日新增：458
- Topics：暂无
- 项目类型：AI/Agent 工程项目
...
![earendil-works/pi 架构拆解图](/img/daily-reports/2026-09-16-github-earendil-works-pi-architecture.svg)
...
![earendil-works/pi 代码调用链图](/img/daily-reports/2026-09-16-github-earendil-works-pi-call-chain.svg)
...
- README 结构：Pi Agent Harness / All Packages / Permissions & Containerization / Contributing / Development / Building standalone binaries from release source
- 开篇信息：> New issues and PRs from new contributors are auto-closed by default. Maintainers review auto-closed issues daily. See [CONTRIBUTING.md](CONTRIBUTING.md). This is the home of the Pi agent harness project including our self extensible coding agent. To learn more about Pi:

值得优先打开的文件或目录：

- `packages/agent/README.md`
- `packages/agent/benchmark/session/README.md`
- `packages/agent/docs/mobile-handoff/02-plugins/02-sandbox/README.md`
- `packages/agent/docs/mobile-handoff/02-plugins/02-sandbox/package.json`
...
| 文件/目录 | 阅读重点 |
| --- | --- |
| `packages/agent/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/agent/benchmark/session/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/agent/docs/mobile-handoff/02-plugins/02-sandbox/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/agent/docs/mobile-handoff/02-plugins/02-sandbox/package.json` | 看任务状态、计划、执行循环和 observation 如何更新。 |
| `packages/agent/docs/mobile-handoff/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/agent/package.json` | 看任务状态、计划、执行循环和 observation 如何更新。 |
| `packages/ai/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/ai/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/chord/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/chord/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/chord/src/delta/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/client/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
