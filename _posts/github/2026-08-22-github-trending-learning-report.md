---
layout: post
title: "GitHub Trending 精读：PostHog/posthog (2026-08-22)"
subtitle: "单个开源项目深度拆解"
date: 2026-08-22
author: "zwt"
...
- 语言：Python
- Stars：38,314，Forks：3,233，今日新增：335
...
![PostHog/posthog 架构拆解图](/img/daily-reports/2026-08-22-github-posthog-posthog-architecture.svg)
...
![PostHog/posthog 代码调用链图](/img/daily-reports/2026-08-22-github-posthog-posthog-call-chain.svg)
...
- `cli/Cargo.toml`
- `cli/README.md`
- `packages/llm-normalizer/package.json`
...
| `packages/llm-normalizer/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
