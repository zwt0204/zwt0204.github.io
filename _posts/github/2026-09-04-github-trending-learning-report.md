---
layout: post
title: "GitHub Trending 精读：NousResearch/hermes-agent (2026-09-04)"
subtitle: "单个开源项目深度拆解"
date: 2026-09-04
author: "zwt"
...
- 语言：Python
- Stars：241,037，Forks：49,403，今日新增：774
...
![NousResearch/hermes-agent 架构拆解图](/img/daily-reports/2026-09-04-github-nousresearch-hermes-agent-architecture.svg)
...
![NousResearch/hermes-agent 代码调用链图](/img/daily-reports/2026-09-04-github-nousresearch-hermes-agent-call-chain.svg)
...
- 开篇信息：Use any model you want — [Nous Portal](https://portal.nousresearch.com), OpenRouter, OpenAI, your own endpoint, and [many others](https://hermes-agent.nousresearch.com/docs/integrations/providers). Switch with `hermes model` — no code changes, no lock-in. curl -fsSL https://hermes-agent.nousresearch.com/install.sh | bash > **Heads up:** Native Windows runs Hermes without WSL — CLI, gateway, TUI, and tools all work natively. If you'd rather use WSL2, the Linux/macOS one-liner above works there too. Found a bug? Plea

值得优先打开的文件或目录：

- `docs/middleware/README.md`
- `docs/observability/README.md`
- `tests/conformance/persistence/README.md`
...
- `apps/desktop/electron/find-in-page-native-fixture/package.json`
...
| `tests/conformance/persistence/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
...
| `apps/desktop/electron/find-in-page-native-fixture/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `apps/desktop/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `apps/desktop/scripts/perf/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
