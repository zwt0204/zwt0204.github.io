---
layout: post
title: "GitHub Trending 精读：apache/maka (2026-08-26)"
subtitle: "单个开源项目深度拆解"
date: 2026-08-26
author: "zwt"
...
- 语言：TypeScript
- Stars：3,397，Forks：336，今日新增：543
- Topics：agent-runtime、ai、ai-agent、apache、cli、desktop
- 项目类型：AI/Agent 工程项目
...
![apache/maka 架构拆解图](/img/daily-reports/2026-08-26-github-apache-maka-architecture.svg)
...
![apache/maka 代码调用链图](/img/daily-reports/2026-08-26-github-apache-maka-call-chain.svg)
...
- README 结构：Why Maka / Surfaces / Current capabilities / Agent Runtime / Desktop workspace / Evaluation
- 开篇信息：Licensed to the Apache Software Foundation (ASF) under one or more contributor license agreements. See the NOTICE file distributed with this work for additional information

值得优先打开的文件或目录：

- `packages/cli/README.md`
- `packages/cli/package.json`
- `packages/computer-use/package.json`
- `packages/core/package.json`
- `packages/eval/README.md`
- `packages/eval/harbor/deepseek-harness-profile/package.json`
...
| `packages/computer-use/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/core/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/eval/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/eval/harbor/deepseek-harness-profile/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/eval/harbor/deepseek-harness-toolchain/package.json` | 看工具注册、权限、参数 schema、超时和失败回退。 |
| `packages/eval/harbor/egress-proxy/Dockerfile` | 用于定位项目的核心边界和上下游依赖。 |
| `packages/eval/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/mcp/package.json` | 看工具注册、权限、参数 schema、超时和失败回退。 |
| `packages/runtime-host/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/runtime/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
