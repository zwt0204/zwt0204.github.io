---
layout: post
title: "GitHub Trending 精读：mukul975/Anthropic-Cybersecurity-Skills (2026-06-23)"
subtitle: "单个开源项目深度拆解"
date: 2026-06-23
author: "zwt"
...
- 语言：Python
- Stars：20,267，Forks：2,352，今日新增：956
...
![mukul975/Anthropic-Cybersecurity-Skills 架构拆解图](/img/daily-reports/2026-06-23-github-mukul975-anthropic-cybersecurity-skills-architecture.svg)
...
![mukul975/Anthropic-Cybersecurity-Skills 代码调用链图](/img/daily-reports/2026-06-23-github-mukul975-anthropic-cybersecurity-skills-call-chain.svg)
...
| `skills/abusing-dpapi-for-credential-access/scripts/agent.py` | 看单个能力单元的目录结构、输入输出、脚本与参考资料如何组合。 |
| `skills/abusing-shadow-credentials-for-privesc/references/api-reference.md` | 看单个能力单元的目录结构、输入输出、脚本与参考资料如何组合。 |
| `skills/abusing-shadow-credentials-for-privesc/scripts/agent.py` | 看单个能力单元的目录结构、输入输出、脚本与参考资料如何组合。 |
