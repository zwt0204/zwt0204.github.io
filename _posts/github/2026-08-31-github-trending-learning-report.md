---
layout: post
title: "GitHub Trending 精读：K-Dense-AI/scientific-agent-skills (2026-08-31)"
subtitle: "单个开源项目深度拆解"
date: 2026-08-31
author: "zwt"
...
- 语言：Python
- Stars：39,993，Forks：3,713，今日新增：1,114
- Topics：agent-skills、ai-scientist、bioinformatics、chemoinformatics、claude、claude-skills
- 官网/演示：[https://k-dense.ai](https://k-dense.ai)
- 项目类型：AI/Agent 工程项目
...
![K-Dense-AI/scientific-agent-skills 架构拆解图](/img/daily-reports/2026-08-31-github-k-dense-ai-scientific-agent-skills-architecture.svg)
...
![K-Dense-AI/scientific-agent-skills 代码调用链图](/img/daily-reports/2026-08-31-github-k-dense-ai-scientific-agent-skills-call-chain.svg)
...
- README 结构：Scientific Agent Skills / 🎥 More tutorials / 📦 What's Included / 📋 Table of Contents / 🚀 Why Use This? / ⚡ **Accelerate Your Research**
- 开篇信息：> **🔔 Claude Scientific Skills is now Scientific Agent Skills.** Same skills, broader compatibility — now works with any AI agent that supports the open [Agent Skills](https://agentskills.io/) standard, not just Claude. > **New: [K-Dense BYOK](https://github.com/K-Dense-AI/k-dense-byok)** — A free, open-source AI co-scientist that runs on your desktop, powered by Scientific Agent Skills. Bring your own API keys, pick from 40+ models, and get a full research workspace with web search, file handling, 100+ scientific

值得优先打开的文件或目录：

- `tests/market-research-reports/fixtures/README.md`
- `README.md`
- `pyproject.toml`
- `skills/clinical-decision-support/references/README.md`
- `skills/clinical-reports/references/README.md`
- `skills/geomaster/README.md`
- `skills/latex-posters/references/README.md`
- `skills/research-grants/references/README.md`
...
| 文件/目录 | 阅读重点 |
| --- | --- |
| `tests/market-research-reports/fixtures/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `pyproject.toml` | 先看可执行入口、依赖边界、构建脚本和发布形态。 |
| `skills/clinical-decision-support/references/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `skills/clinical-reports/references/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `skills/geomaster/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `skills/latex-posters/references/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `skills/research-grants/references/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `skills/research-lookup/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `skills/timesfm-forecasting/examples/global-temperature/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `skills/treatment-plans/references/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `docs/images/clinical-decision-support.png` | 用于定位项目的核心边界和上下游依赖。 |
