---
layout: post
title: "GitHub Trending 精读：bytedance/deer-flow (2026-08-02)"
subtitle: "单个开源项目深度拆解"
date: 2026-08-02
author: "zwt"
...
- 语言：Python
- Stars：78,798，Forks：10,750，今日新增：209
...
![bytedance/deer-flow 架构拆解图](/img/daily-reports/2026-08-02-github-bytedance-deer-flow-architecture.svg)
...
![bytedance/deer-flow 代码调用链图](/img/daily-reports/2026-08-02-github-bytedance-deer-flow-call-chain.svg)
...
- `backend/packages/harness/deerflow/community/boxlite/README.md`
...
| `backend/packages/harness/deerflow/community/boxlite/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `backend/packages/harness/deerflow/community/tenki/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `backend/packages/harness/pyproject.toml` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `backend/pyproject.toml` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
