---
layout: post
title: "GitHub Trending 精读：bytedance/deer-flow (2026-06-22)"
subtitle: "单个开源项目深度拆解"
date: 2026-06-22
author: "zwt"
...
- 语言：Python
- Stars：74,297，Forks：10,005，今日新增：442
...
![bytedance/deer-flow 架构拆解图](/img/daily-reports/2026-06-22-github-bytedance-deer-flow-architecture.svg)
...
![bytedance/deer-flow 代码调用链图](/img/daily-reports/2026-06-22-github-bytedance-deer-flow-call-chain.svg)
...
- README 结构：🦌 DeerFlow - 2.0 / Official Website / Coding Plan from ByteDance Volcengine / InfoQuest / Table of Contents / One-Line Agent Setup
...
| `docker/provisioner/Dockerfile` | 用于定位项目的核心边界和上下游依赖。 |
| `docker/provisioner/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `frontend/Dockerfile` | 用于定位项目的核心边界和上下游依赖。 |
| `frontend/Makefile` | 用于定位项目的核心边界和上下游依赖。 |
