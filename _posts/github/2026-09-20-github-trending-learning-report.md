---
layout: post
title: "GitHub Trending 精读：addyosmani/agent-skills (2026-09-20)"
subtitle: "单个开源项目深度拆解"
date: 2026-09-20
author: "zwt"
...
- 语言：JavaScript
- Stars：97,262，Forks：10,262，今日新增：556
- Topics：agent-skills、antigravity、claude-code、codex、cursor、skills
- 官网/演示：[https://skills.addy.ie](https://skills.addy.ie)
- 项目类型：AI/Agent 工程项目
...
![addyosmani/agent-skills 架构拆解图](/img/daily-reports/2026-09-20-github-addyosmani-agent-skills-architecture.svg)
...
![addyosmani/agent-skills 代码调用链图](/img/daily-reports/2026-09-20-github-addyosmani-agent-skills-call-chain.svg)
...
- README 结构：Agent Skills / Commands / Quick Start / Adoption / All 25 Skills / Meta - Discover which skill applies
- 开篇信息：Skills encode the workflows, quality gates, and best practices that senior engineers use when building software. These ones are packaged so AI agents follow them consistently across every phase of development. DEFINE PLAN BUILD VERIFY REVIEW SHIP ┌──────┐ ┌──────┐ ┌──────┐ ┌──────┐ ┌──────┐ ┌──────┐
...
- `docs/advanced-per-agent-configuration.md`
- `docs/agents.md`
...
| `evals/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `evals/fixtures/browser-testing-with-devtools/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `evals/fixtures/ci-cd-and-automation/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `evals/fixtures/test-driven-development-ecosystem/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `evals/fixtures/test-driven-development/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `evals/fixtures/test-driven-development/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `docs/advanced-per-agent-configuration.md` | 看任务状态、计划、执行循环和 observation 如何更新。 |
| `docs/agents.md` | 看任务状态、计划、执行循环和 observation 如何更新。 |
| `docs/copilot-cli-setup.md` | 用于定位项目的核心边界和上下游依赖。 |
| `docs/gemini-cli-setup.md` | 用于定位项目的核心边界和上下游依赖。 |
| `.claude/commands/test.md` | 看测试覆盖的是数据结构、转换规则、执行脚本还是端到端路径。 |
