---
layout: post
title: "GitHub Trending 精读：BuilderIO/agent-native (2026-09-22)"
subtitle: "单个开源项目深度拆解"
date: 2026-09-22
author: "zwt"
...
- 语言：TypeScript
- Stars：6,134，Forks：557，今日新增：607
- Topics：agent-native、agents、ai、react、typescript
- 官网/演示：[https://www.agent-native.com](https://www.agent-native.com)
- 项目类型：AI/Agent 工程项目
...
![BuilderIO/agent-native 架构拆解图](/img/daily-reports/2026-09-22-github-builderio-agent-native-architecture.svg)
...
![BuilderIO/agent-native 代码调用链图](/img/daily-reports/2026-09-22-github-builderio-agent-native-call-chain.svg)
...
- README 结构：Agent-Native / Quick start / Why build agents with UIs? / How Agent-Native works / Example: a shared action / Included
- 开篇信息：media="(prefers-color-scheme: dark)" srcset="https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F5476444e54ee4a958966c90caca468e3" />

值得优先打开的文件或目录：

- `packages/agent-browser-extension/README.md`
- `packages/agent-browser-extension/package.json`
- `packages/agent-chrome-extension/README.md`
- `packages/agent-chrome-extension/package.json`
- `packages/agentkit/README.md`
- `packages/agentkit/package.json`
- `packages/browser-control-extension-core/package.json`
- `packages/code-agents-ui/package.json`
- `packages/core/README.md`
- `packages/core/package.json`
- `packages/core/src/templates/default/package.json`
- `packages/core/src/templates/headless/package.json`

### 关键文件怎么读

| 文件/目录 | 阅读重点 |
| --- | --- |
| `packages/agent-browser-extension/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/agent-browser-extension/package.json` | 看任务状态、计划、执行循环和 observation 如何更新。 |
| `packages/agent-chrome-extension/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/agent-chrome-extension/package.json` | 看任务状态、计划、执行循环和 observation 如何更新。 |
| `packages/agentkit/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/agentkit/package.json` | 看任务状态、计划、执行循环和 observation 如何更新。 |
| `packages/browser-control-extension-core/package.json` | 看 IDE/前端入口如何把用户操作转成后端 agent 请求。 |
| `packages/code-agents-ui/package.json` | 看任务状态、计划、执行循环和 observation 如何更新。 |
| `packages/core/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/core/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/core/src/templates/default/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/core/src/templates/headless/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
