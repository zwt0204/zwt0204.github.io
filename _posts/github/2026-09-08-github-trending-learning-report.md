---
layout: post
title: "GitHub Trending 精读：bytedance/deer-flow (2026-09-08)"
subtitle: "单个开源项目深度拆解"
date: 2026-09-08
author: "zwt"
...
- 语言：Python
- Stars：81,960，Forks：11,297，今日新增：195
...
![bytedance/deer-flow 架构拆解图](/img/daily-reports/2026-09-08-github-bytedance-deer-flow-architecture.svg)
...
![bytedance/deer-flow 代码调用链图](/img/daily-reports/2026-09-08-github-bytedance-deer-flow-call-chain.svg)
...
- README 结构：🦌 DeerFlow - 2.0 / Official Website / Sister Projects / Coding Plan from ByteDance Volcengine / InfoQuest / Table of Contents
- 开篇信息：English | [中文](./README_zh.md) | [日本語](./README_ja.md) | [Français](./README_fr.md) | [Русский](./README_ru.md) > On February 28th, 2026, DeerFlow claimed the 🏆 #1 spot on GitHub Trending following the launch of version 2. Thanks a million to our incredible community — you made this happen! 💪🔥 DeerFlow (**D**eep **E**xploration and **E**fficient **R**esearch **Flow**) is an open-source **super agent harness** that orchestrates **sub-agents**, **memory**, and **sandboxes** to do almost anything — powered by **extens

值得优先打开的文件或目录：

- `examples/deerflow-extension-example/README.md`
- `examples/deerflow-extension-example/pyproject.toml`
- `Makefile`
- `README.md`
- `backend/Dockerfile`
- `backend/Makefile`
...
- `backend/packages/harness/deerflow/agents/memory/backends/README.md`
...
| 文件/目录 | 阅读重点 |
| --- | --- |
| `examples/deerflow-extension-example/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `examples/deerflow-extension-example/pyproject.toml` | 看 IDE/前端入口如何把用户操作转成后端 agent 请求。 |
| `Makefile` | 用于定位项目的核心边界和上下游依赖。 |
| `README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `backend/Dockerfile` | 用于定位项目的核心边界和上下游依赖。 |
| `backend/Makefile` | 用于定位项目的核心边界和上下游依赖。 |
| `backend/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `backend/docs/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `backend/packages/extension-api/pyproject.toml` | 看 IDE/前端入口如何把用户操作转成后端 agent 请求。 |
| `backend/packages/harness/deerflow/agents/memory/backends/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `backend/packages/harness/deerflow/agents/memory/backends/honcho/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `backend/packages/harness/deerflow/agents/memory/backends/mem0/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
