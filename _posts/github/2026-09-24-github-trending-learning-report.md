---
layout: post
title: "GitHub Trending 精读：dream-num/univer (2026-09-24)"
subtitle: "单个开源项目深度拆解"
date: 2026-09-24
author: "zwt"
...
- 语言：TypeScript
- Stars：16,530，Forks：1,463，今日新增：1,142
- Topics：board、collaboration、data-table、doc、docx、excel
- 官网/演示：[https://docs.univer.ai](https://docs.univer.ai)
- 项目类型：AI/Agent 工程项目
...
![dream-num/univer 架构拆解图](/img/daily-reports/2026-09-24-github-dream-num-univer-architecture.svg)
...
![dream-num/univer 代码调用链图](/img/daily-reports/2026-09-24-github-dream-num-univer-call-chain.svg)
...
- README 结构：✨ What is Univer? / Build a collaborative tool with Univer Office SDK / Built with Univer Office SDK / Featured example: Univer Workspace / Other examples / 🌟 Highlights
- 开篇信息：Spreadsheets · Documents · Presentations · Bases · Boards · PDFs (coming soon) High-performance, fully customizable Office SDK Build embeddable productivity experiences with a plugin architecture, Canvas-based rendering,

值得优先打开的文件或目录：

- `packages/action-recorder/README.md`
- `packages/action-recorder/package.json`
- `packages/core/README.md`
- `packages/core/package.json`
- `packages/core/src/docs/data-model/text-x/README.md`
- `packages/data-validation/README.md`
- `packages/data-validation/package.json`
- `packages/design/README.md`
- `packages/design/package.json`
- `packages/docs-drawing-ui/README.md`
- `packages/docs-drawing-ui/package.json`
- `packages/docs-drawing/README.md`

### 关键文件怎么读

| 文件/目录 | 阅读重点 |
| --- | --- |
| `packages/action-recorder/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/action-recorder/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/core/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/core/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/core/src/docs/data-model/text-x/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/data-validation/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/data-validation/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/design/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/design/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/docs-drawing-ui/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/docs-drawing-ui/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/docs-drawing/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
