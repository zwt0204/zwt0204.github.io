---
layout: post
title: "GitHub Trending 精读：Shubhamsaboo/awesome-llm-apps (2026-07-14)"
subtitle: "单个开源项目深度拆解"
date: 2026-07-14
author: "zwt"
...
- 语言：Python
- Stars：119,878，Forks：17,793，今日新增：996
- Topics：agents、llms、python、rag
- 官网/演示：[https://www.theunwindai.com](https://www.theunwindai.com)
- 项目类型：AI/Agent 工程项目
...
![Shubhamsaboo/awesome-llm-apps 架构拆解图](/img/daily-reports/2026-07-14-github-shubhamsaboo-awesome-llm-apps-architecture.svg)
...
![Shubhamsaboo/awesome-llm-apps 代码调用链图](/img/daily-reports/2026-07-14-github-shubhamsaboo-awesome-llm-apps-call-chain.svg)
...
- README 结构：🌟 Awesome LLM Apps / 💡 Why this exists / 🚀 Quick Start / 🔥 Featured This Month / 📑 Table of Contents / 📂 Featured AI Projects
- 开篇信息：AI Agents · Always-on Agents · Multi-agent Teams · MCP Agents · RAG · Voice Agents · Agent Skills · Fine-tuning</p> You shouldn't have to rebuild the same RAG pipeline, agent loop, or MCP integration from scratch every time you start a new LLM project. > ⭐ **If this saves you time, [star the repo](https://github.com/Shubhamsaboo/awesome-llm-apps/stargazers) - that's how the next developer discovers it.**
...
| `advanced_ai_agents/autonomous_game_playing_agent_apps/ai_3dpygame_r1/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `advanced_ai_agents/autonomous_game_playing_agent_apps/ai_chess_agent/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `advanced_ai_agents/autonomous_game_playing_agent_apps/ai_tic_tac_toe_agent/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `advanced_ai_agents/multi_agent_apps/agent_teams/ag2_adaptive_research_team/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `advanced_ai_agents/multi_agent_apps/agent_teams/ai_competitor_intelligence_agent_team/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `advanced_ai_agents/multi_agent_apps/agent_teams/ai_finance_agent_team/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `advanced_ai_agents/multi_agent_apps/agent_teams/ai_game_design_agent_team/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `advanced_ai_agents/multi_agent_apps/agent_teams/ai_legal_agent_team/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `advanced_ai_agents/multi_agent_apps/agent_teams/ai_legal_agent_team/local_ai_legal_agent_team/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `advanced_ai_agents/multi_agent_apps/agent_teams/ai_real_estate_agent_team/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `advanced_ai_agents/multi_agent_apps/agent_teams/ai_recruitment_agent_team/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
