---
layout: post
title: "GitHub Trending 精读：Kilo-Org/kilocode (2026-06-19)"
subtitle: "单个开源项目深度拆解"
date: 2026-06-19
author: "zwt"
...
- 语言：TypeScript
- Stars：24,331，Forks：2,785，今日新增：1,345
...
![Kilo-Org/kilocode 架构拆解图](/img/daily-reports/2026-06-19-github-kilo-org-kilocode-architecture.svg)
...
![Kilo-Org/kilocode 代码调用链图](/img/daily-reports/2026-06-19-github-kilo-org-kilocode-call-chain.svg)
...
- README 结构：Installation / npm / curl / pnpm / bun / Homebrew (macOS / Linux)
- 开篇信息：English | <a href="README.zh.md">简体中文</a> | <a href="README.zht.md">繁體中文</a> | <a href="README.ko.md">한국어</a> | <a href="README.de.md">Deutsch</a> | <a href="README.es.md">Español</a> | <a href="README.fr.md">Français</a> | <a href="README.it.md">Italiano</a> | <a href="README.da.md">Dansk</a> | <a href="README.ja.md">日本語</a> | <a href="README.pl.md">Polski</a> | <a href="README.ru.md">Русский</a> | <a href="README.bs.md">Bosanski</a> | <a href="README.ar.md">العربية</a> | <a href="README.no.md">Norsk</a> | <a href
...
| 文件/目录 | 阅读重点 |
| --- | --- |
| `packages/containers/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/containers/base/Dockerfile` | 用于定位项目的核心边界和上下游依赖。 |
| `packages/containers/bun-node/Dockerfile` | 用于定位项目的核心边界和上下游依赖。 |
| `packages/containers/jetbrains/Dockerfile` | 用于定位项目的核心边界和上下游依赖。 |
| `packages/containers/publish/Dockerfile` | 用于定位项目的核心边界和上下游依赖。 |
| `packages/containers/rust/Dockerfile` | 用于定位项目的核心边界和上下游依赖。 |
| `packages/containers/tauri-linux/Dockerfile` | 用于定位项目的核心边界和上下游依赖。 |
| `packages/core/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/core/src/github-copilot/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/effect-drizzle-sqlite/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `packages/http-recorder/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `packages/http-recorder/package.json` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
