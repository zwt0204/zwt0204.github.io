---
layout: post
title: "GitHub Trending 精读：addyosmani/agent-skills (2026-08-09)"
subtitle: "单个开源项目深度拆解"
date: 2026-08-09
author: "zwt"
...
- 语言：JavaScript
- Stars：84,641，Forks：9,116，今日新增：779
...
![addyosmani/agent-skills 架构拆解图](/img/daily-reports/2026-08-09-github-addyosmani-agent-skills-architecture.svg)
...
![addyosmani/agent-skills 代码调用链图](/img/daily-reports/2026-08-09-github-addyosmani-agent-skills-call-chain.svg)
...
- README 结构：Agent Skills / Commands / Quick Start / Adoption / All 24 Skills / Meta - Discover which skill applies
...
| `.gemini/commands/test.toml` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `.github/workflows/test-plugin-install.yml` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `AGENTS.md` | 看任务状态、计划、执行循环和 observation 如何更新。 |
| `agents/test-engineer.md` | 看任务状态、计划、执行循环和 observation 如何更新。 |
