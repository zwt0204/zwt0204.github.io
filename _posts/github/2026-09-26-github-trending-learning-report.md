---
layout: post
title: "GitHub Trending 精读：rohitg00/ai-engineering-from-scratch (2026-09-26)"
subtitle: "单个开源项目深度拆解"
date: 2026-09-26
author: "zwt"
...
- 语言：Python
- Stars：57,733，Forks：10,049，今日新增：1,177
...
![rohitg00/ai-engineering-from-scratch 架构拆解图](/img/daily-reports/2026-09-26-github-rohitg00-ai-engineering-from-scratch-architecture.svg)
...
![rohitg00/ai-engineering-from-scratch 代码调用链图](/img/daily-reports/2026-09-26-github-rohitg00-ai-engineering-from-scratch-call-chain.svg)
...
- README 结构：From the creator of [Agent Memory - #1 Persistent memory ⭐](https://github.com/rohitg00/agentmemory) <a href="https://github.com/rohitg00/agentmemory/stargazers"><img src="https://img.shields.io/github/stars/rohitg00/agentmemory?style=flat-square&labelColor=fafaf5&color=3553ff" alt="GitHub stars"></a> which naturally works with any agents or chat assistants. / Start here: choose what you want to build / Sponsors / Use every lesson the same way / Clone it and produce your first evidence / Add the AI tutor in 30 seconds
...
- `certifications/claude/README.md`
- `certifications/mcpa/README.md`
- `glossary/README.md`
- `i18n/ar/README.md`
- `i18n/de/README.md`
- `i18n/es/README.md`
...
| `book/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `certifications/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `certifications/claude/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `certifications/mcpa/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `glossary/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `i18n/ar/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `i18n/de/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `i18n/es/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `i18n/fr/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `i18n/hi/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `i18n/it/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
