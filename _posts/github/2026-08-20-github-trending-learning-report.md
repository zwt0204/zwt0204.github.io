---
layout: post
title: "GitHub Trending 精读：mukul975/Anthropic-Cybersecurity-Skills (2026-08-20)"
subtitle: "单个开源项目深度拆解"
date: 2026-08-20
author: "zwt"
...
- 语言：Python
- Stars：29,895，Forks：3,543，今日新增：766
...
![mukul975/Anthropic-Cybersecurity-Skills 架构拆解图](/img/daily-reports/2026-08-20-github-mukul975-anthropic-cybersecurity-skills-architecture.svg)
...
![mukul975/Anthropic-Cybersecurity-Skills 代码调用链图](/img/daily-reports/2026-08-20-github-mukul975-anthropic-cybersecurity-skills-call-chain.svg)
...
- README 结构：Anthropic Cybersecurity Skills / The largest open-source cybersecurity skills library for AI agents / Give any AI agent the security skills of a senior analyst / Six frameworks, one skill library / 🆕 MITRE Fight Fraud Framework (F3) — 94 fraud-relevant skills / MITRE ATT&CK v19.1 — 805/817 skills mapped
- 开篇信息：> ⚠️ **Community Project** — This is an independent, community-created project. Not affiliated with Anthropic PBC. > > 🔐 **Authorized & lawful use only.** This library includes offensive and dual-use techniques (e.g. red-team C2, phishing simulation, exploitation) intended for **authorized penetration testing, security research, defense, and education**. Only use them against systems you own or have **explicit written permission** to test, and comply with all applicable laws and rules of engagement. You are solely
...
| `mappings/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `mappings/mitre-attack/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `mappings/nist-csf/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `mappings/owasp/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `tools/README.md` | 确认项目承诺、安装方式、核心概念和使用边界。 |
| `.github/ISSUE_TEMPLATE/config.yml` | 看配置约束、默认行为、兼容平台和发布/集成方式。 |
| `skills/abusing-dpapi-for-credential-access/references/api-reference.md` | 看单个能力单元的目录结构、输入输出、脚本与参考资料如何组合。 |
| `skills/abusing-dpapi-for-credential-access/scripts/agent.py` | 看任务状态、计划、执行循环和 observation 如何更新。 |
| `skills/abusing-shadow-credentials-for-privesc/references/api-reference.md` | 看单个能力单元的目录结构、输入输出、脚本与参考资料如何组合。 |
| `skills/abusing-shadow-credentials-for-privesc/scripts/agent.py` | 看任务状态、计划、执行循环和 observation 如何更新。 |
| `skills/acquiring-disk-image-with-dd-and-dcfldd/references/api-reference.md` | 看单个能力单元的目录结构、输入输出、脚本与参考资料如何组合。 |
